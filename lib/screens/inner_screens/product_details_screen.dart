...
final productId=ModalRoute.of(context)!.settings.arguments as String;
    ...
    return    getCurrProduct == null?const SizedBox.shrink(): Scaffold(
      appBar: AppBar(
            ...
            const SizedBox(
             ...
             Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                const   TitlesTextWidget(label: "About this item", fontSize: 20),
                  SubtitleTextWidget(label: "In ${getCurrProduct.productCategory}", fontSize: 20)
                ],
              ),
            ),
            const SizedBox(
